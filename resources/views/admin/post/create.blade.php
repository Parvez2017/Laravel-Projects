...
@section('content')
    ...
    <div class="container-fluid">
        <form action="{{route('admin.post.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <label for="post">Add a New post</label>
        <!-- Vertical Layout -->
                ...
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" id="title" class="form-control" placeholder="Enter a title" name="title">
                            </div>
                        </div>
                        ...
                        <h2>Categories and Tags </h2>
                            ...
                            <div class="form-group">
                                <div class="form-line" {{$errors->has('categories')? 'focused':''}}>
                                    <label for="post">Select Category</label>
                                    <select name="categoires[]" id="category" class="form-control show-tick" data-live-search="true" multiple>
